...
COPY account/build.gradle /home/gradle/java-code/
...
RUN gradle :account:build --no-daemon --parallel --build-cache
...
WORKDIR /app
COPY --from=build /home/gradle/src/account/build/libs/account-${APP_VERSION}.jar app.jar
